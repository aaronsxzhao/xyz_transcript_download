...
# 8 MB chunks complete within Cloudflare / Render request timeouts;
# 4 concurrent workers balance throughput vs origin load.
...
VIDEO_UPLOAD_CLIENT_CONCURRENCY = _get_env_int("VIDEO_UPLOAD_CLIENT_CONCURRENCY", 4, min_val=1)
